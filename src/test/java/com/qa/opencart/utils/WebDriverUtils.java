...
/**
 * This class is used to write webdriver utility methods created on top of
 * webdriver methods
 */
...
public class WebDriverUtils {
	...
	/**
	 * This method checks whether particular dropdown is selected or not or checkbox
	 * is checked or not
	 * 
	 * @param element
	 * @return
	...
	/**
	 * Selects an option from list box if list has
	 * <ul>
	 * and
	 * <li>
	 *
	...
	/**
	 * This method performs drag and drop using clickAndHold(), moveToElement() and
	 * release()
	 * 
	 * @param src
	 * @param tgt
	...
	/**
	 * This method performs dragAndDropBy x,y coordinates using
