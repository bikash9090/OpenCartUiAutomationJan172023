...
public class RegistrationPage extends WebDriverUtils {
	...
	public void fillAddressDetails(String company, String addr1, String addr2, String city, String postcode,
			String optiontxt, String attrval) throws InterruptedException {
		try {
			setCompany(company);
			setAddress1(addr1);
			setAddress2(addr2);
